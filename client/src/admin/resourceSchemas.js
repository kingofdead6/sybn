...
export const RESOURCE_SCHEMAS = {
  programs: {
    ...
    fields: [
      ...
      { name: 'modules', type: 'modulelist' },
      { name: 'resources.interactive', type: 'text' },
      { name: 'resources.videoPlaylist', type: 'text' },
      { name: 'resources.pdfUrl', type: 'text' },
      { name: 'image', type: 'image' },
      { name: 'category', type: 'text' },
      { name: 'accent', type: 'select', options: ['green', 'orange', 'blue', 'slate', 'navy'] },
      { name: 'bandTitle', type: 'checkbox' },
      { name: 'bandHeading', type: 'bilingual' },
      { name: 'ctaLabel', type: 'bilingual' },
      { name: 'formHeading', type: 'bilingual' },
      { name: 'formIntro', type: 'bilingual-textarea' },
      { name: 'formNote', type: 'bilingual-textarea' },
      { name: 'formFields', type: 'formbuilder' },
  ...
  courses: {
    ...
    fields: [
      ...
      { name: 'title', type: 'bilingual', required: true },
      { name: 'code', type: 'text' },
      { name: 'category', type: 'reference', resource: 'categories' },
      { name: 'description', type: 'bilingual-textarea' },
      { name: 'image', type: 'image' },
