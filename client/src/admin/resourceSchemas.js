...
export const RESOURCE_SCHEMAS = {
  programs: {
    ...
    fields: [
      ...
      { name: 'track', type: 'select', options: ['entrepreneurship', 'trainers', 'ai'] },
  ...
  courses: {
    ...
    fields: [
      ...
      { name: 'formNote', type: 'bilingual-textarea' },
      { name: 'formFields', type: 'formbuilder' },
      { name: 'registrationType', type: 'select', options: ['internal', 'external'] },
      { name: 'externalUrl', type: 'text' },
      { name: 'externalProvider', type: 'text' },
      { name: 'published', type: 'checkbox' },
    ],
  },
  team: {
  ...
  forums: {
    ...
    fields: [
      ...
      { name: 'status', type: 'select', options: ['open', 'full', 'announced-soon'] },
      { name: 'seatsTotal', type: 'number' },
      { name: 'seatsTaken', type: 'number' },
      { name: 'notes', type: 'bilingual-textarea' },
      { name: 'agreementUrl', type: 'text' },
      { name: 'partnershipUrl', type: 'text' },
      { name: 'registrationType', type: 'select', options: ['internal', 'external'] },
      { name: 'externalUrl', type: 'text' },
      { name: 'externalProvider', type: 'text' },
    ],
